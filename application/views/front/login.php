            ...
            <div class="line">
               ...
               <div class="margin">
                  ...
                  <div class="s-12 m-12 l-4">
                    ...
                    <?php echo form_open(base_url('user/auth/login'), 'class="customform" '); ?>
                   
                      <div class="s-12"><input name="username" placeholder="Your e-mail" title="Your e-mail" type="text" /></div>
                      <div class="s-12"><input name="password" placeholder="Your Password" title="Your Password" type="password" /></div>
                      <div class="s-12 m-12 l-4">
                        <input type="submit" value="Submit" name="submit" style="width: max-content;" class="color-btn form-control" ></div>
                    <?php echo form_close(); ?>
                  </div>  
