   ...
   <body class="size-1140">
      ...
      <section>
         ...
         <div id="carousel">
            <div id="owl-demo" class="owl-carousel owl-theme"> 
               <div class="item">
                  <img src="<?= base_url()?>assets/front/img/first.jpg" alt="">
                  <div class="line"> 
               ...
               <div class="item">
                  <img src="<?= base_url()?>assets/front/img/second.jpg" alt="">
                  <div class="line">
                     <div class="text hide-s"> 
                        <div class="line"> 
                          <div class="prev-arrow hide-s hide-m">
               ...
               <div class="item">
                  <img src="<?= base_url()?>assets/front/img/third.jpg" alt="">
                  <div class="line">
                     <div class="text hide-s">
                        <div class="line"> 
                          <div class="prev-arrow hide-s hide-m">
         ...
         <div id="about-us">
            <div class="s-12 m-12 l-6 media-container">
               <img src="<?= base_url()?>assets/front/img/about.jpg" alt="">
            </div>
         ...
         <div id="books">
            <div class="line">
               <h2 class="section-title">Flip Books</h2>
               <div class="tabs">
                  <div class="tab-item tab-active">
                    <a class="tab-label active-btn">Category One</a>
                    <div class="tab-content">
                      <div class="margin">
                          <?php foreach($books as $k=>$item){ ?>
                        <div class="s-12 m-6 l-3"><a target="_blank" href="<?= base_url()?>book/<?php echo $item['slug']; ?>" class="our-work-container lightbox margin-bottom"><div class="our-work-text"><h4><?php echo $item['title']; ?></h4><p><?php echo substr($item['description'],0,42); ?>...</p></div><img src="<?= base_url()?><?php echo $item['cover_image']; ?>" alt=""></a></div>
                       <?php  }?>
                      </div>
                    </div>  
                  </div>
                  <div class="tab-item">
                    <a class="tab-label">Category 2</a>        
                    <div class="tab-content">
                      <div class="margin">
                        <?php foreach($books as $k=>$item){ ?>
                        <div class="s-12 m-6 l-3"><a target="_blank" href="<?= base_url()?>book/<?php echo $item['slug']; ?>" class="our-work-container lightbox margin-bottom"><div class="our-work-text"><h4><?php echo $item['title']; ?></h4><p><?php echo substr($item['description'],0,42); ?>...</p></div><img src="<?= base_url()?><?php echo $item['cover_image']; ?>" alt=""></a></div>
                  ...
                  <div class="tab-item">
                    <a class="tab-label">Category 3</a>
                    <div class="tab-content">
                      <div class="margin">
                          <?php foreach($books as $k=>$item){ ?>
                        <div class="s-12 m-6 l-3"><a target="_blank" href="<?= base_url()?>book/<?php echo $item['slug']; ?>" class="our-work-container lightbox margin-bottom"><div class="our-work-text"><h4><?php echo $item['title']; ?></h4><p><?php echo substr($item['description'],0,42); ?>...</p></div><img src="<?= base_url()?><?php echo $item['cover_image']; ?>" alt=""></a></div>
                  ...
                  <div class="tab-item">
                    <a class="tab-label">Category 4</a>
                    <div class="tab-content">
                      <div class="margin">
                          <?php foreach($books as $k=>$item){ ?>
                        <div class="s-12 m-6 l-3"><a target="_blank" href="<?= base_url()?>book/<?php echo $item['slug']; ?>" class="our-work-container lightbox margin-bottom"><div class="our-work-text"><h4><?php echo $item['title']; ?></h4><p><?php echo substr($item['description'],0,42); ?>...</p></div><img src="<?= base_url()?><?php echo $item['cover_image']; ?>" alt=""></a></div>
            ...
            <div class="line">
               ...
               <div class="margin">
                  <div class="s-12 m-12 l-3 hide-m hide-s margin-bottom right-align">
                    <img src="<?= base_url()?>assets/front/img/contact.jpg" alt="">
                  </div>
                  <div class="s-12 m-12 l-4 margin-bottom right-align">
                     ...
                     <br />
                     <h3>Social</h3>
                     <p><i class="icon-facebook icon"></i> <a href="#">Vision Design - graphic zoo</a></p>
                     <p><i class="icon-facebook icon"></i> <a href="#">Responsee</a></p>
                     <p class="margin-bottom"><i class="icon-twitter icon"></i> <a href="#">Responsee</a></p>
                  </div>
      ...
      <footer>
         <div class="line">
            ...
            <div class="s-12 l-6">
               <a class="right" href="http://octterai.com" title="Responsee - lightweight responsive framework">Design and coding<br> by octterai Team</a>
            </div>
         </div>
      </footer>
